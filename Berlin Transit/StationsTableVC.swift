...
//    
//    var defaultSearchBarIcon: UIImage?
//    
...
//        self.defaultSearchBarIcon = self.searchBar.image(for: .search, state: .normal)
//        
//        let attributes = [NSFontAttributeName: UIFont.fontAwesome(ofSize: 20)] as [String: Any]
//        self.locationButton.setTitleTextAttributes(attributes, for: .normal)
//        self.locationButton.title = String.fontAwesomeIcon(name: .locationArrow)
...
//            self.searchBar.setImage(defaultSearchBarIcon, for: .search, state: .normal)
